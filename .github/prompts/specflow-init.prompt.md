...
Translate Claude tool references per `#file:AGENTS.md` (§ Tool surface translation). `Bash` calls become terminal tool calls; `Read`/`Write` become `#search/codebase` / `#edit/editFiles`.
